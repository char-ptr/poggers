use crate::{structures::{modules::{Module,ModuleError}, process::ProcessBasics}, sigscan::SigScan};
...
pub trait ProcessUtils : ProcessBasics {
    ...
    fn get_base_module(&self) -> Result<Module<Self>,ModuleError> where Self: Sized + SigScan {
